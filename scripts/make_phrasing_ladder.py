...
fig.text(0.01, 0.02, "Key: Adv = adversarial phrasing · Orig = original phrasing · Scene-Desc = Gemini-written scene description · Gem-Pro = Gemini-pro (reasoning on) · Qwen = frozen Qwen3.5-9B · Rules = phrasing rules v3 · every pipeline ends at π0", fontsize=7, color="#4a5568")
