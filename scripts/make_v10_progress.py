...
a2.set_title(f"GROUND TRUTH: val-8 rollouts (192 eps/cell) — {len([c for c in cells if c[chr(39)+"probe"+chr(39)] != chr(39)+"v10_ref"+chr(39)])}/28 curve cells (+3 rules refs)\nadv>pol at every step so far (repair-shaped gains)", fontsize=9)
