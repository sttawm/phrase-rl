#!/usr/bin/env python3
"""A34 applies (natural condition only, image-conditioned set): one book x one applier x all three sealed conditions.
...
for cond, bases in (("nat", nat),):
    ...
    out = REPO / f"results/sealed/ph_a34_{tag}_{applier}_{cond}.parquet"
