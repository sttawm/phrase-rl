#!/usr/bin/env python3
"""results/charts/results_translating.png -- the merged main-results figure.
...
fig.savefig("results/charts/results_translating.png", dpi=140, bbox_inches="tight",
            pad_inches=0.25)
print("chart -> results/charts/results_translating.png")
