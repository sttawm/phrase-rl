...
ROWS = [
 ...
 ("L",             f"{L_REC}", "layouts per base — FIXED set from 0-17 only (18-23 is the reserved held-out set)", "rollout"),
 ...
 ("layouts 18-23", "reserved", "held-out confirmation set (EXPERIMENT.md:400-407) — final read only", "rollout"),
 ("RUN",           "", "", ""),
