...
NAME = {
    ...
    "frozen_gemini_trace": "adversarial phrasing + gem-trace ⇒ frozen Qwen ⇒ π0",
    "frozen_selftrace": "adversarial phrasing + qwen-trace ⇒ frozen Qwen ⇒ π0",
    "sft_v2": "adversarial phrasing + qwen-trace ⇒ bridge-phrase SFT'd Qwen ⇒ π0",
    "v6_rl": "adversarial phrasing + gem-trace ⇒ v6-RL Qwen ⇒ π0",
    "rules_v3_gemini_trace": "adversarial phrasing + gem-trace ⇒ frozen Qwen + RULES ⇒ π0",
    "rules_gemini": "adversarial phrasing + gem-trace ⇒ Gemini-flash + RULES ⇒ π0",
    "gemini_bare": "adversarial phrasing + gem-trace ⇒ Gemini-flash bare ⇒ π0",
    "rules_v3_selftrace": "adversarial phrasing + qwen-trace ⇒ frozen Qwen + RULES ⇒ π0",
    "rules_v3_gemini_pro": "adversarial phrasing + gem-trace ⇒ Gemini-pro + RULES (with reasoning) ⇒ π0",
    "gemini_pro_bare": "adversarial phrasing + gem-trace ⇒ Gemini-pro bare (with reasoning) ⇒ π0",
    "claude_agent": "adversarial phrasing + gem-trace ⇒ Claude agent + RULES + corpus ⇒ π0",
    "executor_pair": "adversarial phrasing + gem-trace ⇒ Claude agent + RULES + corpus ⇒ π0",
    "rules_v3_claude_agent": "adversarial phrasing + gem-trace ⇒ Claude agent + RULES + corpus ⇒ π0",
