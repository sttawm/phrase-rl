...
NAME = {
    ...
    "sft_v2": "adversarial phrasing + self-written scene description ⇒ bridge-phrase SFT'd Qwen ⇒ π0",
    "v6_rl": "adversarial phrasing + Gemini scene description ⇒ v6-RL Qwen ⇒ π0",
    "rules_v3_gemini_trace": "adversarial phrasing + Gemini scene description ⇒ frozen Qwen + RULES ⇒ π0",
    "rules_gemini": "adversarial phrasing + Gemini scene description ⇒ Gemini-flash + RULES ⇒ π0",
    "gemini_bare": "adversarial phrasing + Gemini scene description ⇒ Gemini-flash bare ⇒ π0",
    "rules_v3_selftrace": "adversarial phrasing + self-written scene description ⇒ frozen Qwen + RULES ⇒ π0",
    "rules_v3_gemini_pro": "adversarial phrasing + Gemini scene description ⇒ Gemini-pro + RULES (with reasoning) ⇒ π0",
    "gemini_pro_bare": "adversarial phrasing + Gemini scene description ⇒ Gemini-pro bare (with reasoning) ⇒ π0",
