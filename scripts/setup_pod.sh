...
# NB: pytest is a RUNTIME dep of this fork — paligemma_with_expert.py does
# `from pytest import Cache`. Trimming it breaks pi0 import (cost one failure cycle 2026-07-15).
