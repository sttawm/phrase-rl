...
APPLIERS = {
    ...
    "gemini": dict(gemini_model="gemini-pro-latest", gemini_thinking_budget=16384),  # 128->1024 2026-09-01; ->16384 2026-09-04 (user): full budget for every applier run from here
