...
the rewrite beat leaving the instruction alone)
  ...
  [widowx_carrot_on_keyboard_clean]
    ...
    out: 'set the orange carrot on the black keyboard'
    logit: 16.667  (base 0.000, delta +16.667)
  [widowx_carrot_on_wheel_clean]
    in : 'set the carrot on the wheel'
    out: 'set the orange carrot on the black wheel'
  ...
  [widowx_spoon_on_towel]
    ...
    out: 'Grab that spoon and set it on the cloth.'
  ...
  [widowx_coke_can_on_ramekin_clean]
    ...
    out: 'place the red coke can upright inside the white bowl'
    logit: 66.667  (base 50.000, delta +16.667)
  [widowx_spoon_on_towel]
  ...
  [widowx_carrot_on_wheel_clean]
    ...
    out: 'Move the orange carrot to the black wheel.'
    logit: 50.000  (base 0.000, delta +50.000)
  [widowx_spoon_on_towel]
  ...
  [widowx_carrot_on_keyboard_clean]
    ...
    out: 'Place the orange carrot atop the black keyboard.'
    logit: 16.667  (base 0.000, delta +16.667)
  [widowx_coke_can_on_ramekin_clean]
  ...
  [widowx_carrot_on_plate]
    ...
    out: 'Put the orange carrot on the plate.'
    logit: 50.000  (base 16.667, delta +33.333)
  [widowx_carrot_on_plate]
    in : 'Proceed to grasp the carrot and subsequently establish its position atop the dining plate.'
    out: 'Pick up the orange carrot and place it on the green plate.'
    logit: 16.667  (base 33.333, delta -16.667)
  [widowx_carrot_on_plate]
  ...
  [widowx_carrot_on_plate]
    ...
    out: 'Move the orange carrot to the plate.'
    logit: 50.000  (base 16.667, delta +33.333)
  [widowx_carrot_on_wheel_clean]
  ...
  [widowx_coke_can_on_plate_clean]
    ...
    out: 'Put the red coke can onto the plate.'
    logit: 100.000  (base 0.000, delta +100.000)
  [widowx_stack_cube]
  ...
  [widowx_stack_cube]
    ...
    out: 'Place the green block atop the yellow block without disturbing the other objects.'
    logit: 0.000  (base 0.000, delta +0.000)
  [widowx_put_eggplant_in_basket]
  ...
  [widowx_spoon_on_towel]
    ...
    out: 'Pick up the spoon and put it onto the towel.'
    logit: 50.000  (base 0.000, delta +50.000)